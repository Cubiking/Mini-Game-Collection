...
procedure choosed;
   ...
   Case gamenum of 
      ...
      '3':writeln('*                        Game you choosed: Magic Square                        *');
      End;
   writeln('*                                                                              *');
   End;
...
procedure menu;
    ...
    repeat
        Repeat
            ...
            middle;
            writeln('*                                                                              *');
            writeln('*               Please press 1 to start the Number Guessing game               *');
            writeln('*                                                                              *');
            writeln('*                   Please press 2 to start the Mark Six game                  *');
            writeln('*                                                                              *');
            writeln('*                   Please press 3 to start the Magic Square                   *');
            writeln('*                                                                              *');
            ...
            If gamenum=' ' then
                Begin
                head;
                writeln('*      Game 1: Number Guessing game:                                           *');
                writeln('*                                                                              *');
